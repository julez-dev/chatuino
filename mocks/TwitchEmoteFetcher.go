...
func (_m *TwitchEmoteFetcher) GetChannelEmotes(ctx context.Context, broadcaster string) (twitchapi.EmoteResponse, error) {
...
func (_c *TwitchEmoteFetcher_GetChannelEmotes_Call) Return(_a0 twitchapi.EmoteResponse, _a1 error) *TwitchEmoteFetcher_GetChannelEmotes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TwitchEmoteFetcher_GetChannelEmotes_Call) RunAndReturn(run func(context.Context, string) (twitchapi.EmoteResponse, error)) *TwitchEmoteFetcher_GetChannelEmotes_Call {
	_c.Call.Return(run)
	return _c
}

// GetGlobalEmotes provides a mock function with given fields: _a0
func (_m *TwitchEmoteFetcher) GetGlobalEmotes(_a0 context.Context) (twitchapi.EmoteResponse, error) {
	ret := _m.Called(_a0)
...
func (_c *TwitchEmoteFetcher_GetGlobalEmotes_Call) Return(_a0 twitchapi.EmoteResponse, _a1 error) *TwitchEmoteFetcher_GetGlobalEmotes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TwitchEmoteFetcher_GetGlobalEmotes_Call) RunAndReturn(run func(context.Context) (twitchapi.EmoteResponse, error)) *TwitchEmoteFetcher_GetGlobalEmotes_Call {
	_c.Call.Return(run)
	return _c
}
