...
// func newChatWindow(logger zerolog.Logger, tab *tab, emoteStore emoteStore) *chatWindow {
// 	c := &chatWindow{
// 		m:          DefaultKeyMap(),
// 		logger:     logger,
// 		parentTab:  tab,
...
// 		if e, ok := c.emoteStore.GetByText(c.parentTab.channelID, split); ok {
// 			switch e.Platform {
// 			case emote.Twitch:
